...
async function issueCredential() {
    ...
    const { did: issuerDID, credential: issuerAuthBJJCredential } =
     ...
     const latestStateInfo = await dataStorage.identity.getLatestStateById(issuerDID.id.bigInt());
     console.log(latestStateInfo)
    ...
    // console.log((await dataStorage.credential.listCredentials()).length);
}
